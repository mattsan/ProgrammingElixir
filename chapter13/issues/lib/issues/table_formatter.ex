defmodule Issues.TableFormatter do
  ...
  headers. Print a table to STDOUT of the data from each row
  ...
  a column, return a list containg the maximum width of each column
  ...
  @doc """
  Return a format string that hard codes the widths of set of columns.
  ...
  @doc """
  Generate the line taht goes below the column headings. It is a string of
  ...
  and format string, write the extracted data under control of the format string.
  """
